...
class MaskGenerator:
    ...
    def __call__(self):
        ...
        mask = mask.repeat(self.mask_patch_size, axis=0).repeat(self.mask_patch_size, axis=1).repeat(self.mask_patch_size, axis=2)
...
class LAHeart(Dataset):
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        train_path = self._base_dir+'LU_trainv1.txt'
        test_path = self._base_dir+'LU_testv1.txt'
        ...
        if split=='test':
            self.test_list_path = [self._base_dir + "lung_h5/" + item + '.h5' for item in self.image_list]
    ...
    def __getitem__(self, idx):
        ...
        h5f = h5py.File(self._base_dir + "lung_h5/" + image_name + ".h5", 'r')
