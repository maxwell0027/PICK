...
class LAHeart(Dataset):
    ...
    def __init__(self, base_dir=None, split='train', num=None, transform=None):
        ...
        train_path = self._base_dir+'PA_trainv1.txt'
        test_path = self._base_dir+'PA_testv1.txt'
        ...
        if split=='test':
            self.test_list_path = [self._base_dir + "data/" + item + '.h5' for item in self.image_list]
